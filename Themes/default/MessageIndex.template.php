	...
	<div class="tborder topic_table" id="messageindex">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr>
					<td class="icon1 ', $color_class, '">
						<img src="', $settings['images_url'], '/topic/png/', $topic['class'], '.png" alt="Changed this. Check back soon." />
					</td>
			...
			if ($topic['new'] && $context['user']['is_logged'])
					echo '
							<a href="', $topic['new_href'], '" id="newicon' . $topic['first_post']['id'] . '"><img src="Themes/Giggle/svg/new-post.svg" alt="New Posts" class="new_posts" /></a>';
			...
			echo '
					...
					<td class="lastpost ', $alternate_class, '">
						<a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/16/last_post.png" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a>
