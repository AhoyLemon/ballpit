...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		if (!$context['user']['is_guest'] && !empty($category['show_unread']))
			echo '
								<a class="collapse" href="', $scripturl, '?action=unread;c=', $category['id'], '" title="Unread posts in this board">
								<img src="', $settings['images_url'], '/icons/16/unread.png" alt="unread" />
								</a>';
				...
				if (!empty($board['children']))
				{
					...
					foreach ($board['children'] as $child)
					{
						if (!$child['is_redirect'])
							$child['link'] = '<a href="' . $child['href'] . '" ' . ($child['new'] ? 'class="new_posts" ' : '') . 'title="' . ($child['new'] ? $txt['new_posts'] : $txt['old_posts']) . ' (' . $txt['board_topics'] . ': ' . comma_format($child['topics']) . ', ' . $txt['posts'] . ': ' . comma_format($child['posts']) . ')">' . $child['name'] . ($child['new'] ? '</a> <a href="' . $scripturl . '?action=unread;board=' . $child['id'] . '" title="' . $txt['new_posts'] . ' (' . $txt['board_topics'] . ': ' . comma_format($child['topics']) . ', ' . $txt['posts'] . ': ' . comma_format($child['posts']) . ')"><img src="' . $settings['images_url'] . '/icons/16/newinthread.png" class="new_posts" alt="new posts" />' : '') . '</a>';
						else
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_some.png" alt="" /> new posts</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_children.png" alt="" />new posts in children</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_none.png" alt="" /> no new posts</li>
		</ul>
	</div>';
...
function template_info_center()
{
	...
	<div class="roundframe"><div class="innerframe">
		<div class="cat_bar">
			<h3 class="catbg">
				<img class="icon" id="upshrink_ic" src="', $settings['images_url'], '/icons/16/collapse.png" alt="*" title="', $txt['upshrink_description'], '" style="display: none;" />
