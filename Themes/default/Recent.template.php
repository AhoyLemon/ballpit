...
function template_main()
{
	...
	<div id="recent" class="main_section">
		<div class="cat_bar">
			<h3 class="catbg">
				<span class="ie6_header floatleft"><img src="', $settings['images_url'], '/icons/clock.png" alt="" class="icon" />',$txt['recent_posts'],'</span>
			</h3>
		</div>
...
function template_unread()
{
			...
			echo '
						<tr>
							<td class="', $color_class, ' icon1 windowbg">
								<img src="', $settings['images_url'], '/topic/png/', $topic['class'], '.png" alt="" />
							</td>
							<td class="subject ', $color_class2, ' windowbg2">
								<div>
									...
									<a href="', $topic['new_href'], '" id="newicon', $topic['first_post']['id'], '" alt="new" title="Jump to new posts"><img src="', $settings['images_url'], '/icons/16/newinthread.png" alt="', $txt['new'], '" /></a>
									<p>
							...
							<td class="', $color_class2, ' lastpost windowbg2">
								<a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.gif" alt="', $txt['last_post'], '" title="Jump to last post in thread" style="float: right;" /></a>
	...
	echo '
			<p class="floatleft smalltext" style="min-width:120px;">', !empty($modSettings['enableParticipation']) && $context['user']['is_logged'] ? '
				<img src="' . $settings['images_url'] . '/topic/png/normal_post.png" alt="" align="middle" /> ' . $txt['normal_topic'] . '<br />' : '', '
				<img src="' . $settings['images_url'] . '/topic/png/normal_poll.png" alt="" align="middle" /> ' . $txt['poll'] . '<br />
				<img src="' . $settings['images_url'] . '/topic/png/normal_post_sticky.png" alt="" align="middle" /> ' . sprintf($txt['sticky_topic'] . '<br />
				<img src="' . $settings['images_url'] . '/topic/png/normal_post_locked.png" alt="" align="middle" /> ' . sprintf($txt['locked_topic'] . '
			</p>
			<p class="smalltext">
				<img src="' . $settings['images_url'] . '/topic/png/hot_post.png" alt="" align="middle" /> ' . $txt['hot_topics'], $modSettings['hotTopicPosts']) . '<br />
				<img src="' . $settings['images_url'] . '/topic/png/veryhot_post.png" alt="" align="middle" /> ' . $txt['very_hot_topics'], $modSettings['hotTopicVeryPosts']) . '<br />
				<img src="' . $settings['images_url'] . '/topic/png/my_normal_post.png" alt="" align="middle" /> ' . $txt['participation_caption'] . '
			</p>';
}
