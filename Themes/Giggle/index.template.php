...
<head>';
  ...
  echo '
    ...
    <link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/ballpit.css?lastUpdated=06.08.2017" />';
...

{
  ...
  echo "<script type='text/javascript' src='", $settings["theme_url"], "/scripts/ballpit.js?updated=06.07.17'></script>
</body></html>";
