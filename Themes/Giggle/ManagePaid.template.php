              ...
              */
				...
				echo '
                    ...
                    <div class="button-holder">
                      <button type="submit" name="sub_id[', $subscription['id'], ']" value="', $txt['paid_order'], '" class="button_submit"><span>', sprintf($modSettings['paid_currency_symbol'], $subscription['costs']['fixed']), '</span></button>
                    </div>';
			}
			else
				echo '
