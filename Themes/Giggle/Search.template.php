...
function template_main()
{
	...
	else
	{
		...
		<fieldset class="flow_hidden">
			...
			<div class="roundframe">
				<div class="title_bar">
					<h4 class="titlebg">
						<a href="javascript:void(0);" onclick="expandCollapseBoards(); return false;"><img src="', $settings['images_url'], '/icons/16/expand.png" id="expandBoardsIcon" alt="" /></a> <a href="javascript:void(0);" onclick="expandCollapseBoards(); return false;"><strong>', $txt['choose_board'], '</strong></a>
					</h4>
				</div>
	...
	foreach ($context['categories'] as $category)
	{
		echo '
						<li class="category">
							...
							<ul>';
		// BELOW: THIS CODE BLOCK IS A TOTAL HACK. NEED TO FIGURE OUT WHY THAT THING GETS DISPLAYED TWICE.
		echo '
			<style type="text/css">
				.ignoreboards.floatleft .category:last-child { display:none; }
			</style>
		';
	...
	echo '
					...
					<div style="display:block, clear:both; float:none; overflow:hidden; width:100%; min-width:120px; padding-top:18px;">
	...
	<script type="text/javascript"><!-- // --><![CDATA[
		...
		function expandCollapseBoards()
		{
			...
			document.getElementById("expandBoardsIcon").src = smf_images_url + (current ? "/icons/16/expand.png" : "/icons/16/collapse.png");
		}';
